...
gameAlong =
  do let player1 = Player "1" "Mike"
     ...
     let rwt = execWriterT (State.evalStateT (playGame players4 deck) (emptyGameState playerNames))
...
gameInteractive =
  do let player1 = Player "1" "Mike"
     ...
     let playerNames = Map.keys players4
     let rwt = runWriterT (State.evalStateT (playGame players4 deck) (emptyGameState playerNames))
